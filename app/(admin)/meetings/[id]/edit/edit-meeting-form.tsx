        ...
        return (
            ...
            className="space-y-4">
                ...
                <option value="special">
                    ...
                    <div id="meetingType-error" aria-live="polite" aria-atomic="true" className="text-red-400 text-sm mt-1">
                    ...
                    <div id="presiding-error" aria-live="polite" aria-atomic="true" className="text-red-400 text-sm mt-1">
                ...
                />
                    ...
                    <div id="conducting-error" aria-live="polite" aria-atomic="true" className="text-red-400 text-sm mt-1">
                ...
                <input
                    ...
                    <div id="openingPrayer-error" aria-live="polite" aria-atomic="true" className="text-red-400 text-sm mt-1">
                    ...
                    name="speakers"
                    type="text"
                    defaultValue={meeting.speakers.map(s => s.name).join(", ")}
                    ...
                    <div id="closingPrayer-error" aria-live="polite" aria-atomic="true" className="text-red-400 text-sm mt-1">
